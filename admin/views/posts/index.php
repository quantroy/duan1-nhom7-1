                    ...
                    <tbody>
                        <?php foreach ($posts as $index => $item) : ?>
                            <tr>
                                ...
                                <td>
                                    <img style="display: block;max-width:70px;max-height:70px;width: auto;height: auto;" src="<?= IMG_URL . $item['thumbnail1'] ?>">
                                </td>
                                <td>
                                    <img style="display: block;max-width:70px;max-height:70px;width: auto;height: auto;" src="<?= IMG_URL . $item['thumbnail2'] ?>">
                                </td>
                                <td><?= $item['content1']?></td>
                                <td><?= $item['content2']?></td>
