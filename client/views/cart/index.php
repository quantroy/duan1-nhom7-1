                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="display: flex; justify-content: center;align-items: center;height: 124px;" class="">
                                    ...
                                    <input onkeyup="toTal(<?= $i ?>)" id="quantity"
                                        style="width: 50px; text-align: center; border: none; background-color: #FAFAFA;"
                                        value="<?= $carts[$i]['quantity'] ?>" type="text" name="quantity">

                                    <button index="<?= $i ?>" id="augment"
                                        style="width: 20px;text-align: center; height: 25px;display: flex; justify-content: center; align-items: center;"
                                        type="button" class="btn btn-info rounded-circle">+</button>
                                </td>
                                ...
                                <td class="shoping__cart__item__close">
                                    <span data-toggle="modal" data-target="#dell"
                                        onclick="check_delete('trà sữa có tên /<?= getNamePro($carts[$i]['product_id']) . '(' . $carts[$i]['product_size'] . ')' . '/ Khỏi giỏ hàng' ?>', <?= $carts[$i]['id'] ?> )"
                    ...
                    <div class="shoping__discount">
                        ...
                        <div class="container mt-3">
                            ...
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a style="cursor: default;" style="background-color: red; " class="nav-link active"
                                        id="custom-tabs-three-home-tab" data-toggle="pill"
                                        href="#custom-tabs-three-home" role="tab" aria-controls="custom-tabs-three-home"
                                        aria-selected="true">Nhập thông tin</a>
                                </li>

                            </ul>
                            <div class="mt-2" style="text-align: right;width: 100%;"><button type="button"
                ...
                <div class="shoping__checkout">
                    ...
                    <ul>
                        ...
                        <li>Phí vận chuyển <span
                                id="priceShip"><?= number_format(priceShip(), 0, '', ',') . 'đ' ?></span></li>
                        <li>Bạn có <strong
                                id="points"><?php echo number_format(point($_SESSION['auth']['id'], 0, '', ',')) ?></strong>
                            điểm tích<span id="render_points" dataWait=<?php echo point($_SESSION['auth']['id']) ?>
                                data="0"><button onclick="clickpoints()" id="btn_points" type="button"
                                    class="btn btn-success">Áp dụng</button></span></li>
            ...
            <div style="overflow-y: auto;height: 250px; " class="modal-body mt-5">
                <ul>
                    ...
                    <button onclick="getAddRess(<?= $i ?>)" data-dismiss="modal" class="btn btn-success"> Nhập thông
                        tin này</button>
                    <li id="modalName" style="margin-left: 30px;margin-top: 5px;"
                        data="<?= $address[$i]['recciever'] ?>"><strong>Tên người nhận</strong>:
